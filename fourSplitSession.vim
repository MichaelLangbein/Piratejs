...
silent only
cd ~/javascript/piratejs
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +25 src/server/server.js
badd +15 src/server/serverEngine.js
badd +11 src/client/client.js
badd +27 src/client/clientEngine.js
args src/server/server.js
edit src/server/serverEngine.js
...
wincmd w
argglobal
edit src/client/clientEngine.js
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal nobinary
